...
Credit
-------
This is based on https://github.com/bobbyrenwick/ansible-pip. However, that uses the Ansible
`get_url` module which frequently fails for me. This uses good old wget.
